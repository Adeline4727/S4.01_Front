...
const newAnnonce = {
  ...
  "natureHebergementBien": {
    "natureHebergementId": 0,
    "natureHebergementLibelle": "string",
    "annonces": [],
        ...
        <form id="depos-annonce-form">
            ...
            <div v-else-if="step == 4">
                ...
                <div>
                    ...
                    <div>
                        <FieldInputWithUnit v-model="newAnnonce.surfaceHabitable" name="surface" label="Surface habitable" unit="m²" required="true" />
